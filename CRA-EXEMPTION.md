...
This document explains why the **CYFRAM Arduino Library** is exempt from the EU Cyber Resilience Act (CRA) obligations.

---

## 1. Background

The Cyber Resilience Act (CRA) requires manufacturers of products with digital elements to address security, reporting, and compliance obligations.  
Open-source software, distributed **without commercial intent** or monetized offerings, may be exempt under current CRA guidance.

**CYFRAM** is:

- An **Arduino library** for I²C FRAM memory access.
- Distributed under **GPL-2.0 license**.
- Maintained by an **individual contributor**, without commercial support or paid services.

---

## 2. Exemption Criteria

CYFRAM meets the exemption criteria for pure OSS because:

1. **Open Source License**:  
   Distributed under GPL-2.0, fully open source, freely available.

2. **No Commercial Activities**:  
   There are no sales, paid services, or monetized offerings related to this project.

3. **No Product Placed on the Market**:  
   The maintainer does not offer CYFRAM as part of a commercial product.

4. **Individual Development Model**:  
   Contributions are voluntary, and there is no corporate manufacturer.
...
- CYFRAM is considered **CRA-Exempt (pure OSS)** under current EU guidance.
- Users of this library **are responsible** for their own products’ compliance if integrated into commercial hardware.
...
- [Patchstack CRA Checklist](https://patchstack.com/whitepaper/cyber-resilience-act-checklist/?utm_source=chatgpt.com)

---

> This statement documents the exemption status for audit and transparency purposes.  
> It may be updated if CRA interpretation or project status changes.
